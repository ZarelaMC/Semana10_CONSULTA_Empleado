...
<h3>Consulta de Empleado</h3>
	<div class="row" style="margin-top: 2%">
		...
		<div class="custom-control custom-switch">
			<label class="custom-control-input" for="id_estado">Estado</label>
			<input class="custom-control-labl" type="checkbox" id="id_estado" name="estado" checked="checked">
		</div>
	</div>
	<div class="row" style="margin-top: 2%">
		<div class="col-sm-6">
			<label class="control-label" for="id_fecha_desde">Fecha de nacimiento (Desde)</label>
			<input class="form-control" type="date" id="id_fecha_desde" name="desde">
		</div>
		<div class="col-sm-6" style="margin-top: 2%">
			<label class="control-label" for="id_fecha_hasta">Fecha de nacimiento (Hasta)</label>
			<input class="form-control" type="date" id="id_fecha_hasta" name="hasta">
		</div>
	</div>
	<div class="row" style="margin-top: 2%">
		<div class="col-sm-6">
			<label class="col-lg-3 control label" for="id_pais">Paìs</label>
